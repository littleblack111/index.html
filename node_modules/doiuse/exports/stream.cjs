...
var Duplexify__default = /*#__PURE__*/_interopDefaultLegacy(Duplexify);
...
class RuleUsageTransform extends node_stream.Transform {
  ...
  constructor(options, filename = '<streaming css input>') {
    ...
    this.#processor = postcss__default["default"]([new DoIUse({
  ...
  async _transform(rule, encoding, callback) {
    let caughtError;
    try {
      const mapper = new sourcemap__default["default"].SourceMapGenerator();
...
class SourceMapTransform extends node_stream.Transform {
  constructor() {
...
class CssUsageDuplex extends Duplexify__default["default"] {
  /**
   * @param {Object} options
   * @param {string} options.browsers
   * @param {FeatureKeys[]} [options.ignore]
